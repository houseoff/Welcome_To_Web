<?php
    ...
    array(
      ...
      'date' => "Янв. 2015 - Наст. время",
      'description' => "Описание работы фронтэнд-разработчика"
    ),
    array(
      'job' => "Веб-разработчик",
      'date' => "Март 2012 - Дек. 2014",
      'description' => "Описание работы веб-разработчика"
    ),
    array(
      'job' => "Графический дизайнер",
      'date' => "Июнь 2010 - Март 2012",
      'description' => "Описание работы графического дизайнера"
    )
  );
?>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['date']; ?></span></h6>
